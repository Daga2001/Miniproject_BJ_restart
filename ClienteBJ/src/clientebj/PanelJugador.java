...
public class PanelJugador extends JPanel {
	...
	public void paintComponent(Graphics g) {
		...
		for(int i=0;i<dibujoRecordar.size();i++) {
			...
			//g.drawImage(dibujoRecordar.get(i).getCartaRecordar().getImagen(), dibujoRecordar.get(i).getxRecordar(), 35, getFocusCycleRootAncestor());
	...
	private class Recuerdo implements Serializable{
